(function (app) {
    ...
    app.controller('movieDetailsCtrl', moviesDetailsCtrl);

    moviesDetailsCtrl.$inject = ['$scope', '$location', '$routeParams', 'apiService', 'notificationService']

    function moviesDetailsCtrl($scope, $location, $routeParams, apiService, notificationService) {
        ...
        function loadRentalHistory() {
            ...
            apiService.get('/api/rentals/' + $routeParams.id, null, rentalHistoryLoadCompleted, rentalHistoryLoadFailed);
        }
